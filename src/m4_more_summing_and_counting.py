...
def run_test_factorial():
    ...
    # Test 4: 19
    answer_from_oracle = math.factorial(19)
    answer_from_my_code = factorial(19)
...
def run_test_count_cosines_from():
    ...
    # Test 2: 0, 0, 0
    expected = 1
    answer = count_cosines_from(0, 0, 0)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3: 3, 5, 0.1
    expected = 1
    answer = count_cosines_from(3, 5, 0.1)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4: 3, 9, -100
    expected = 7
    answer = count_cosines_from(3, 9, -100)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5: 8, 9, -0.3
    expected = 1
    answer = count_cosines_from(8, 9, -0.3)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6: 5, 9, 0
    expected = 3
    answer = count_cosines_from(5, 9, 0)
...
def sum_unit_fractions_from(m, n):
    ...
    sum_fraction = 0
    for k in range((n - m) + 1):
        sum_fraction = sum_fraction + 1/(m + k)
